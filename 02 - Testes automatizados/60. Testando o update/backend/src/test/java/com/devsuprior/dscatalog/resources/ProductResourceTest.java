...
public class ProductResourceTest {
    ...
    void setUp() throws Exception {
        ...
        Mockito.when(service.update(existingId, any())).thenReturn(productDTO);

        Mockito.when(service.update(nonExistingId, any())).thenThrow(ResourceNotFoundException.class);
